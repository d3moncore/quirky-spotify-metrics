...
const TopTracks = () => {
  ...
  const { 
    items: tracks, 
    loading 
  } = useTopItems<SpotifyTrack>('tracks', timeRange);
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="animate-pulse text-spotify-green font-semibold">Loading your top tracks...</div>
      </div>
    );
  }
    ...
    <div className="min-h-screen pb-16">
      ...
      <div className="pt-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <header className="mb-12 animate-in">
          <h1 className="text-3xl font-bold text-spotify-gradient mb-2">Your Top Tracks</h1>
          <p className="text-muted-foreground">Discover your most played songs on Spotify</p>
        </header>
